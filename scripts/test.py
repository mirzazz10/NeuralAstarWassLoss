...
#     neural_astar.load_state_dict(load_from_ptl_checkpoint(checkpointPath))    
#     neural_astar.eval()
...
#     return mean_hmean, mean_p_exp, mean_p_opt


# # if __name__ == "__main__":
# baseFilePath = 'C://Users//mirza//ASU//MS_master_folder//semester_3//perceptionRobotics//finalUnetRuns'
# checkpointfiles = glob( baseFilePath + '/*/*/*/checkpoints/*.ckpt')
# print( checkpointfiles)
# for each in checkpointfiles:
#     if 'NormalLoss' in each.split( '/'):
#         checkpointPath = each
#         h_mean, p_exp, p_opt = main()
#         print( 'Normal Loss', h_mean, p_exp, p_opt)
#     else:
#         checkpointPath = each
#         h_mean, p_exp, p_opt = main()
#         print( 'Normal Loss', h_mean, p_exp, p_opt)
#         print( 'Wassertein Loss', h_mean, p_exp, p_opt)
